app.controller('relatorioDelegadoController', ['$http', '$uibModal', '$location', '$rootScope', '$scope', '$routeParams', 'cidadeService', 'relatorioService',
function($http, $uibModal, $location, $rootScope, $scope, $routeParams, cidadeService, relatorioService) {
  ...
  $scope.setCidade = function(i){
    ...
    relatorioService.getListDelegados();
  }
