app.controller('apuracao2010CargoGeralController', ['$rootScope', '$scope', 'cidadeService', 'apuracao2010Service', 'governadorCandidatoService','presidenteCandidatoService', 'senadorCandidatoService', 'deputadoCandidatoService',
		function($rootScope, $scope, cidadeService, apuracao2010Service ,governadorCandidatoService, presidenteCandidatoService, senadorCandidatoService, deputadoCandidatoService){
	...
	$scope.filter = function(){
		...
		apuracao2010Service.getListCargoGeral();
	}
