app.controller('apuracao2014PartidoCargoController', ['$rootScope', '$scope', 'cidadeService', 'partidoService', 'apuracao2014Service',
		function($rootScope, $scope, cidadeService, partidoService, apuracao2014Service){
	...
	$scope.filter = function(){
		...
		apuracao2014Service.getListPartidoCargo();
	}
