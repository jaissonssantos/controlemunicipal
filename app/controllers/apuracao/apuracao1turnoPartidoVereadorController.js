...
app.controller('apuracao1turnoPartidoVereadorController', ['$rootScope', '$scope', 'cidadeService', 'apuracaoPartidoService',
	...
	$scope.filter = function(){
		...
		apuracaoPartidoService.getListPartidoVereadorMunicipio();
	}
