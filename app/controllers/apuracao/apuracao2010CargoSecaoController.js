app.controller('apuracao2010CargoSecaoController', ['$rootScope', '$scope', 'cidadeService', 'zonaService', 'secaoService','apuracao2010Service',
		function($rootScope, $scope, cidadeService, zonaService, secaoService, apuracao2010Service){
	...
	$scope.filter = function(){
		...
		apuracao2010Service.getListCargoSecao();
	}
