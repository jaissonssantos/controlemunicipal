app.controller('mapaVotacao20142TurnoController', ['$http', 'uiGmapGoogleMapApi', '$uibModal', '$location', '$rootScope', '$scope', '$routeParams', 'locaisMapaService', 
...
$scope.lng = '-67.822265'; 
  ...
  $scope.templateUrl = "views/apuracao/conteudovotacao20142turno.html";
...
$scope.gerarMapa = function(){
    ...
    if($scope.municipio == 1){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListAcrelandia20142turno();
      });
    }
    if($scope.municipio == 2){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListAssisBrasil20142turno();
      });
    }
    if($scope.municipio == 3){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListBrasileia20142turno();
      });
    }
    ...
    if($scope.municipio == 4){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListBujari20142turno();
      });
    }
    ...
    if($scope.municipio == 5){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListCapixaba20142turno();
      });
    }
    ...
    if($scope.municipio == 6){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListCruzeiroDoSul20142turno();
      });
    }
    ...
    if($scope.municipio == 7){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListEpitaciolandia20142turno();
      });
    }
    ...
    if($scope.municipio == 8){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListFeijo20142turno();
      });
    }
    ...
    if($scope.municipio == 9){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListJordao20142turno();
      });
    }
    ...
    if($scope.municipio == 10){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListMancioLima20142turno();
      });
    }
    ...
    if($scope.municipio == 11){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListManoelUrbano20142turno();
      });
    }
    ...
    if($scope.municipio == 12){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListMarechalThaumaturgo20142turno();
      });
    }
    ...
    if($scope.municipio == 13){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPlacidoDeCastro20142turno();
      });
    }
    ...
    if($scope.municipio == 14){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPortoAcre20142turno();
      });
    }
    ...
    if($scope.municipio == 15){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPortoWalter20142turno();
      });
    }
    ...
    if($scope.municipio == 16){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListRioBranco20142turno();
      });
    }
    ...
    if($scope.municipio == 17){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListRodriguesAlves20142turno();
      });
    }
    ...
    if($scope.municipio == 18){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSantaRosaDoPurus20142turno();
      });
    }
    ...
    if($scope.municipio == 19){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSenaMadureira20142turno();
      });
    }
    ...
    if($scope.municipio == 20){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSenadorGuiomard20142turno();
      });
    }
    ...
    if($scope.municipio == 21){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListTarauaca20142turno();
      });
    }
    ...
    if($scope.municipio == 22){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListXapuri20142turno();
      });
    }
