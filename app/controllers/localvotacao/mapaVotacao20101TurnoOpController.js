app.controller('mapaVotacao20101TurnoOpController', ['$http', 'uiGmapGoogleMapApi', '$uibModal', '$location', '$rootScope', '$scope', '$routeParams', 'locaisMapaService', 
...
$scope.lng = '-67.822265'; 
  ...
  $scope.templateUrl = "views/apuracao/conteudovotacao20101turnoop.html";
...
$scope.gerarMapa = function(){
    ...
    if($scope.municipio == 1){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListAcrelandia20101turnoOp();
      });
    }
    if($scope.municipio == 2){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListAssisBrasil20101turnoOp();
      });
    }
    if($scope.municipio == 3){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListBrasileia20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 4){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListBujari20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 5){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListCapixaba20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 6){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListCruzeiroDoSul20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 7){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListEpitaciolandia20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 8){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListFeijo20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 9){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListJordao20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 10){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListMancioLima20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 11){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListManoelUrbano20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 12){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListMarechalThaumaturgo20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 13){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPlacidoDeCastro20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 14){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPortoAcre20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 15){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListPortoWalter20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 16){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListRioBranco20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 17){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListRodriguesAlves20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 18){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSantaRosaDoPurus20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 19){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSenaMadureira20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 20){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListSenadorGuiomard20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 21){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListTarauaca20101turnoOp();
      });
    }
    ...
    if($scope.municipio == 22){
      ...
      uiGmapGoogleMapApi.then(function(maps) {
        $scope.map = { center: { latitude: $scope.lat, longitude: $scope.lng }, zoom: 16 };
        locaisMapaService.getListXapuri20101turnoOp();
      });
    }
