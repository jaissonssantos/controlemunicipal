app.controller('mapaVotacaoOpController', ['$http', 'uiGmapGoogleMapApi', '$uibModal', '$location', '$rootScope', '$scope', '$routeParams', 'locaisMapaService', 
function($http, uiGmapGoogleMapApi, $uibModal, $location, $rootScope, $scope, $routeParams, locaisMapaService) {
  ...
  $scope.templateUrl = "views/apuracao/conteudovotacaomo.html";
